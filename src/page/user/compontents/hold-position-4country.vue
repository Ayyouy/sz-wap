          ...
          <div class="order-info-box">
            <div class="order-title">
              ...
              <span class="direction pull-right big-font">
                ...
                <b
                  ...
                  >{{ item.now_price }}</b
                >
                <!-- <b :class="orderDirection == '买涨'? 'space red': 'space green'">{{ item.orderDirection }}</b> -->
              </span>
            </div>
            <div class="order-info">
              <p class="clearfix">
                ...
                >
                <span class="col-xs-4"
                  >折扣率:<b class="space">{{ (item.discount * 100).toFixed(2) }}%</b></span
                >
                <span class="col-xs-4"
                  ...
                  <b
                    ...
                    :class="
                      item.rateProfitAndLose < 0
                        ...
                        : 'space green'
                    "
                    >{{ item.rateProfitAndLose }}{{item.symnol}}</b
                  >
                </span>
              </p>
              <p class="clearfix">
                <span class="col-xs-4"
                  ><b class="space"></b></span
                >
                <span class="col-xs-4"
                  ><b class="space"></b>
                </span>
