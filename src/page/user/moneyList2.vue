      ...
      >
        <el-form-item label="状态">
          <el-radio-group v-model="searchForm.aaa">
            ...
            <el-radio label="1" border>转入现金账户</el-radio>
            <el-radio label="2" border>转入基金账户</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="订单编号">
          <el-input v-model="searchForm.ccc" placeholder="请输入" />
        </el-form-item>
...
export default {
  ...
  methods: {
    getList() {
      // let res = await api.getMoneyList(this.searchForm)
      // if (data.status === 0) {
