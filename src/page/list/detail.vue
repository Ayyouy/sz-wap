    ...
    <div class="news-tab">
      <mt-navbar v-model="news">
        <mt-tab-item id="tab_0">
          <span class="tab-name">{{ $t('line.tab1') }}</span>
        </mt-tab-item>
        <mt-tab-item id="tab_1">
          <span class="tab-name">{{ $t('line.tab2') }}</span>
        </mt-tab-item>
        <mt-tab-item id="tab_2">
          <span class="tab-name">{{ $t('line.tab3') }}</span>
        </mt-tab-item>
        <mt-tab-item id="tab_3">
          <span class="tab-name">{{ $t('line.tab4') }}</span>
        </mt-tab-item>
        <mt-tab-item id="tab_4">
          <span class="tab-name">{{ $t('line.tab5') }}</span>
        </mt-tab-item>
      </mt-navbar>
