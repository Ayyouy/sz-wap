  ...
  <div :class="`list-content-wrapper ${$state.theme === 'red' ? 'red-theme' : 'black-theme'}`">
    <ul class="table-list list-table-title">
      <li class="title">
        <div>
          <ul class='clearfix'>
            <li class="li-title">{{ $t('choice.symbol') }}<img :src="sortIcon" alt=""></li>
            <li class="li-base">{{ $t('choice.price') }}<img :src="sortIcon" alt=""></li>
            <li class="li-base">{{ $t('choice.chg') }}<img :src="sortIcon" alt=""></li>
              ...
              <li class="li-title">
                <p class="name">
                  ...
                  <img v-else
                       ...
                       :src="require(`../../../static/img/list/${$state.theme === 'red' ? 'red-' : ''}love-icon.png`)"
                       alt="">
                  {{ item.name }}
                </p>
                <p class="code" style="padding-left: 0px">
                  <span class="code-wra">{{ item.code }}</span>
                  <i class="iconfont kechuang-mark">{{ $t('title1') }}</i>
                </p>
              </li>
              <li class="li-base">
